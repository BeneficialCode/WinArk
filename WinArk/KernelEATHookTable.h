...
class CKernelEATHookTable :
	public CTable<KernelEATHookInfo>,
	public CWindowImpl<CKernelEATHookTable> {
public:
	...
	BEGIN_MSG_MAP(CKernelEATHookTable)
