...
struct NewKernelHandler {
	...
	static inline ULONG_PTR _MaxPhyAddrMask{ 0xfffffffff };
	// same as MAXPHYADDRMASK but also aligns to strip invalid bits
	static inline ULONG_PTR _MaxPhyAddrMaskPb{ 0xffffff000 };
	static inline ULONG_PTR _MaxPhyAddrMaskPbBig{ 0xfffe00000 };
